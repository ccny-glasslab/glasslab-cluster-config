...
class ResearchStore(Protocol):
    ...
    def save_catalog_dataset(self, record: CatalogDatasetRecord) -> CatalogDatasetRecord: ...
    def get_catalog_dataset(self, catalog_id: str) -> CatalogDatasetRecord: ...
    def get_catalog_dataset_by_name(self, name: str) -> CatalogDatasetRecord | None: ...
    ...
    def save_conversation_binding(
        self, record: ConversationSourceBinding
    ) -> ConversationSourceBinding: ...
    ...
    # Corpus-RAG prototype surface (additive). Both backends implement these
    # with identical semantics; see app/corpus_rag/contracts.py for the frozen
    # record shapes these methods exchange.
    ...
    def replace_rag_sections(self, doc_id: str,
                             sections: list[RagSectionRecord]) -> int: ...
    def replace_rag_chunks(self, source_id: str,
                           chunks: list[RagChunkRecord]) -> int: ...
    def search_rag_chunks_fts(self, query: str, *,
                              source_ids: list[str] | None = None,
                              limit: int = 10) -> list[dict[str, Any]]: ...
    def list_rag_chunks(self, *, source_ids: list[str] | None = None,
                        kinds: list[str] | None = None,
                        limit: int | None = None) -> list[dict[str, Any]]: ...
    def upsert_rag_chunk_vectors(self, meta: ChunkVectorMeta,
    ...
    def list_all_knowledge_chunks(self, *,
                                  limit: int | None = None) -> list[dict[str, Any]]: ...
