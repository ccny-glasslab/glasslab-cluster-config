...
* `whatsapp-gateway`, `research-ingress`, and `research-command-router` are
  retired (issue #159); see `docs/glasslab-v2/historical/README.md`. The #173
  workflow-api auth work landed and #289 removed the router's workflow-api
  caller.
