...
- `research-command-router` and its upstream `whatsapp-gateway` and `research-ingress` adapters have been retired (issue #159); see `docs/glasslab-v2/historical/README.md`.
